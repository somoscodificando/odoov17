...
> 💡 **Optimizado para DigitalOcean**: El script está optimizado para funcionar en droplets básicos:
> `1 GB Memory / 1 Intel vCPU / 35 GB Disk / Ubuntu 22.04 (LTS) x64` (~$6/mes)
